...
public class practical_11 {
    public static void main(String[] args) throws ExecutionException {
        Triplet<String, Integer, Character> p1 = Triplet.of("Divy", 18, 'M');
        Triplet<String, Integer, Character> p2 = Triplet.of("Daksh", 20, 'M');
        Triplet<String, Integer, Character> p4 = Triplet.of("Bhavin", 28, 'M');
        Triplet<String, Integer, Character> p3 = Triplet.of("Anish", 26, 'M');
